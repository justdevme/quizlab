...
export default function HomePage() { 
  ...
  const handleExploreClick = () => {
    navigate('/sign-in'); // hoặc '/login' nếu bạn dùng route đó
  };
            ...
            <Col lg={6} md={12}>
              <div className={styles.heroContent}>
                ...
                <div className={styles.heroBtns}>
                  <Button variant="warning" size="lg" className={styles.primaryBtn} onClick={handleExploreClick}>
                    Khám phá ngay
                  </Button>
          ...
          <Row className="align-items-center">
            <Col lg={6} md={12}>
              <div className={styles.aboutImage}>
                <img src={team} alt="Giới thiệu QuizLab" className={styles.image} />
              </div>
            </Col>
            <Col lg={6} md={12}>
